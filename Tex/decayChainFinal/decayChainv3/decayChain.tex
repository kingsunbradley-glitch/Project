...
% 左链文字
%--------------------------------
\node[blk,anchor=west] at ($(hs1.east)+(0.65,0.50)$) {11.165\err{22} MeV\\0.108 ms};
\node[blk,anchor=west]    at ($(sg1.east)+(0.25,0.30)$) {9.103\err{22} MeV\\5.006 s};
\node[blk,anchor=west]    at ($(rf1.east)+(0.20,0.25)$) {8.660\err{21} MeV\\6.340 s};

%--------------------------------
% 右链文字
%--------------------------------
\node[redtxt,anchor=west] at ($(hs2.east)+(0.65,0.50)$) {10.858\err{22} MeV\\8.320 ms};
\node[blk,anchor=west] (sg2txtA) at ($(sg2.east)+(0.25,0.30)$) {8.916\err{21} MeV};
\node[blk,anchor=west] (sg2txtB) at ($(sg2txtA.south west)+(0,-0.12)$) {9.363 s};
