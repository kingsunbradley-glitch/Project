...
] at ($(sg2.east)+(0.25,0.30)$) {8.916\err{14} MeV\\9.363 s};
...
\end{tikzpicture}
\end{document}w我想让\node[redtxt,anchor=west] (sg2txtA) at ($(sg2.east)+(0.25,0.30)$) {8.916\err{14} MeV};
\node[redtxt,anchor=west] (sg2txtB) at ($(sg2txtA.south west)+(0,-0.12)$) {9.363 s};
