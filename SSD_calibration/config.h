...
const char* calibration_param_file = "/home/evalie2/Project/document/273Ds/inter2/SS032_SSD_calibration_params_pro2.txt";
// 第1步程序输出的诊断图目录
const char* output_plot_dir = "/home/evalie2/Project/Function/273Ds/calibration_plots_pro2";
// 第2步程序输出的最终ROOT文件
const char* final_calibrated_root_file = "/home/evalie2/Project/document/273Ds/inter2/SS032_inter2_chain_SSDcal_pro2.root";
...
const double peak_search_threshold = 0.25;

// --- 4. 物理和程序参数 ---
// 使用的线程数 
int num_threads = 12; // 12核心
// SSD总通道数
...
// 留空字符串 "" 则不应用任何额外削减。
const char* global_event_cut = ""; // 示例或空字符串
#endif // CONFIG_H
