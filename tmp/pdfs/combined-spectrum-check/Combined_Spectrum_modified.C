{
    ...
    // X ticks : panel (a)
    //
    // No inward X-axis tick marks are drawn in the upper panel.
    // ============================================================
    ...
    // //
    // // No legend box/line sample.  Put the text at the position where
    // // the former "Total spectrum" legend entry was located.
    // // ============================================================
    ...
    // spectrumLabelA.SetTextSize(legendTextSize);
    // spectrumLabelA.SetTextAlign(12);
    ...
    double spectrumLabelFracY = 0.28;
    ...
    latexA.SetTextSize(commonTextSize);
    ...
    latexB.SetTextSize(commonTextSize);
